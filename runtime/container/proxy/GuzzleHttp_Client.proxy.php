 ...
 */
class Client_a67a5f6a1fc7a2c40a4b31248139bd1a extends Client implements ClientInterface
{
    ...
    public function requestAsync($method, $uri = '', array $options = [])
    {
        ...
        return self::__proxyCall(Client::class, __FUNCTION__, self::getParamsMap(Client::class, __FUNCTION__, func_get_args()), function ($method, $uri = '', array $options = []) use($__function__, $__method__) {
            $options = $this->prepareDefaults($options);
